...
def probability(word, sorted_tuple_of_surr_words):
	prob_w = probs_dict[sorted_tuple_of_surr_words][word]
	return prob_w

print(probability('purchased',('i', 'this')))

# random selection with distribution weights

from random import choices

input_tuple = ('i', 'this')
population = list(probs_dict[input_tuple])
weights = probs_dict[input_tuple].values()

print(choices(population, weights))
print(list(probs_dict[('i', 'this')]))